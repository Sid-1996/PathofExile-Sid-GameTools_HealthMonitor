...
class InventoryTab(QWidget):
    ...
    def _sync_inventory_config(self):
        ...
        # 清理等比 prop 殘留（回退至絕對後不再使用）
        for k in ("inventory_region_prop", "inventory_ui_region_prop", "interface_ui_region_prop", "region_prop", "mana_region_prop", "grid_offset_prop", "pickup_coordinates_prop", "config_version"):
            cfg.pop(k, None)
