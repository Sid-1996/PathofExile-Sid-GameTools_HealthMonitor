...
class AboutTab:
    ...
    def create_about_tab(self):
        ...
        ttk.Label(info_card, text=self._app.get_text("license_display"), font=("Microsoft YaHei", 12)).pack(anchor=tk.W)
        ...
        discord_btn = ttk.Button(row1_frame, text=self._app.get_text("discord_button"), command=discord_placeholder, state="disabled", width=12)
