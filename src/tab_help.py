...
class HelpTab:
    ...
    def create_help_tab(self):
        ...
        hotkey_card = self.create_info_card(
            content_frame,
        ...
        ttk.Label(version_card, text=version_info, justify="left", font=("Microsoft YaHei", 10)).pack(anchor="w")
        ...
        ttk.Label(quickstart_card, text=quickstart_text, justify="left", font=("Microsoft YaHei", 10)).pack(anchor="w")
        ...
        ttk.Label(setup_card, text=setup_guide, justify="left", font=("Microsoft YaHei", 9)).pack(anchor="w")
        ...
        ttk.Label(notes_card, text=notes_text, justify="left", font=("Microsoft YaHei", 10)).pack(anchor="w")
